...
const OWNER_NAME = import.meta.env.VITE_APP_OWNER_NAME || "Arushi Gupta";
const OWNER_EMAIL = import.meta.env.VITE_APP_OWNER_EMAIL || "arushi.gupta@example.com";
    ...
    emailjs
      ...
      .then(
        ...
        (error) => {
          ...
          alert(`Sorry, something went wrong. Please try again or contact me directly at ${OWNER_EMAIL}`);
        }
      );
  };
